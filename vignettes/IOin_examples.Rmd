...
input_hdr = IOin_hdr(
  ...
  stratum = c("defs/veg_douglasfir.def", "stat"),
...
output_filter = IOin_output_filters(filter2,filter3, file_name = "tecfiles/test_output_filter.yml")
...
input_def_pars = IOin_def_pars_simple(
  ...
  list("defs/soil_sandyloam.def", "Ksat_0", 194),
  list("defs/soil_sandyloam.def", "m_v", 0.1423176),
  list("defs/soil_sandyloam.def", "Ksat_0_v", 194),
